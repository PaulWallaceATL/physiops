...
interface GradientTextProps {
  ...
  yoyo?: boolean;
  /** When true, inner gradient element is block and full width for paragraph-style content */
  block?: boolean;
}
...
export default function GradientText({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`relative z-[2] text-transparent bg-clip-text ${block ? "block w-full" : "inline-block"} ${innerClassName}`}
        style={{
          ...gradientStyle,
          backgroundPosition,
